...
object Constants {
    ...
    const val LONG_PRESS_MESSAGE = "Long press for contact's details"
    const val UNDO = "UNDO"
    const val DEFAULT_IMAGE =
        "https://scontent.fiev17-2.fna.fbcdn.net/v/t1.6435-9/242289197_4285719178131249_2304531192454725485_n.jpg?_nc_cat=101&ccb=1-5&_nc_sid=09cbfe&_nc_ohc=Oxz1lcqMvCkAX8NjPEn&_nc_ht=scontent.fiev17-2.fna&oh=b20254fb6d57b2202f29c63d329da38f&oe=616E2EA4"
    const val IMAGE =
        "https://scontent.fiev17-2.fna.fbcdn.net/v/t1.6435-9/60336113_2169614983075023_4549265995994234880_n.jpg?_nc_cat=110&ccb=1-5&_nc_sid=e3f864&_nc_ohc=iX7fG3rbI2QAX8dAVdp&_nc_oc=AQl6JBi7KU-x66EVpQynuxMYVEF7X_ELwgyLLhhRHDHsg_ZZkt5kzZ5LAF_cH3gpTio&_nc_ht=scontent.fiev17-2.fna&oh=2f7de9659dfc36eb2a0b50181bc3030e&oe=61746942"

    // Contacts List Fragment constants
    const val BUNDLE_KEY = "user detail view"
    ...
    const val MY_PROFILE_BACK_STACK = "my profile back stack"
}