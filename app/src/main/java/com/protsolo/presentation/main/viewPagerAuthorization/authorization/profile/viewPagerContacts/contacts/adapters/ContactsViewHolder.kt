...
import com.protsolo.presentation.main.viewPagerAuthorization.authorization.profile.viewPagerContacts.contacts.ContactsFragment.Companion.selectionView
    ...
    fun bind(wrapperUserModel: WrapperUserModel) {
        binding.apply {
            ...
            imageButtonDeleteContact.visibility =
                if (selectionView || wrapperUserModel.addContactView) View.GONE
                else View.VISIBLE
