...
import com.protsolo.presentation.main.viewPagerAuthorization.authorization.profile.viewPagerContacts.ViewPagerContactsFragment
import com.protsolo.presentation.main.viewPagerAuthorization.authorization.profile.viewPagerContacts.ViewPagerContactsFragmentDirections
import com.protsolo.presentation.main.viewPagerAuthorization.authorization.profile.viewPagerContacts.contacts.adapters.ContactsAdapter
import com.protsolo.presentation.main.viewPagerAuthorization.authorization.profile.viewPagerContacts.contacts.adapters.IItemChangedListener
import com.protsolo.presentation.main.viewPagerAuthorization.authorization.profile.viewPagerContacts.contacts.adapters.IItemClickListener
import com.protsolo.presentation.main.viewPagerAuthorization.authorization.profile.viewPagerContacts.contacts.adapters.decorations.ContactListItemDecoration
...
class ContactsFragment : BaseFragment<FragmentContactsBinding>(FragmentContactsBinding::inflate),
    ...
    override fun removeItem(position: Int) {
        ...
        element?.user?.let { viewModel.removeItem(it) }
        ...
        Snackbar.make(
            ...
            element?.user.let { user -> user?.id?.let { id -> viewModel.addItem(id) } }
        }.show()
    }
